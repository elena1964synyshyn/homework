...
// Один тег
// <script> не може мати атрибут src і код всередині.
...
// Широко поширена практика використання констант як псевдонімів для значень, які важко запам’ятати і які відомі до початку
// виконання скрипта.
